...
public class StringNode {
    ...
    public static void doubleChar(char c, StringNode str) {
        ...
        while (trav != null) {
            if (trav.ch == c) {
                StringNode doubleCurrent = new StringNode(c, trav.next);
                trav.next = doubleCurrent;
            }
            trav = trav.next;
        }
    }
                                         ...
                                         char beforeChar) 
    {
        if (str.equals(null)) {
            ...
            return new StringNode(newChar, str);
        } else {
     ...
     */
    public static int length(StringNode str1) {
        if (str1 == null) {
            return 0;
        } 
     ...
     */
    public static void toUpperCase(StringNode str1) {        
        if (str1 == null) {
            return;
        } else {
            str1.ch = Character.toUpperCase(str1.ch);
            toUpperCase(str1.next);
        }
    }  
